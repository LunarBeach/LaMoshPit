...
int main(int argc, char* argv[])
{
    ...
    // Mlt::Producer/Consumer/Filter is created.
    Mlt::Factory::init();

    const QString mltVer  = QString::fromUtf8(mlt_version_get_string());
    const QString ffmpegV = QString::fromUtf8(
        Mlt::Factory::repository() ? "repo loaded" : "repo NOT loaded");
    ...
    layout->addWidget(new QLabel(QString("Repository:   %1").arg(ffmpegV)));
